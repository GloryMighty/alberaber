        ...
        <Card className="p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
          <div className="flex justify-between items-start mb-6">
            <div className="flex items-center space-x-6">
              <div className="relative group">
                <div className="w-32 h-32 rounded-full overflow-hidden bg-social-primary text-white flex items-center justify-center text-4xl">
              ...
              <div>
                {isEditing ? (
                  ...
                  <h1 className="text-2xl font-bold">{profileData.full_name || user?.email?.split("@")[0]}</h1>
                )}
          ...
          <div className="space-y-6">
            ...
            <section className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <h2 className="text-lg font-semibold mb-2 col-span-full">Contact & Social Media</h2>
              
              <div className="space-y-4">
                <div className="flex items-center space-x-2">
                  <Twitter className="w-5 h-5 text-social-primary" />
                  {isEditing ? (
                    <Input
                ...
                <div className="flex items-center space-x-2">
                  <Instagram className="w-5 h-5 text-social-primary" />
                  {isEditing ? (
                    <Input
                ...
                <div className="flex items-center space-x-2">
                  <MessageSquare className="w-5 h-5 text-social-primary" />
                  {isEditing ? (
                    <Input
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-2">
                  <Phone className="w-5 h-5 text-social-primary" />
                  {isEditing ? (
                    <Input
